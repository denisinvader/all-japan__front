<section class="container catalog-filter">
    ...
    <form action="catalog.php">
        ...
        <div class="form-group row">
            <div class="form-field col-t-25 col-50">
                <label>Марка</label>
                <select class="" name="">
                    <option>все</option>
        ...
        <div class="form-group form-group_last row">
            <div class="form-field col-50 col-t-25">
